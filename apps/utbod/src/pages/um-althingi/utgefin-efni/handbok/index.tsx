              ...
              >
                <Stack space={[1, 1, 3]}>
                  <Text variant="default" color="blue400">
                    <Link href="/um-althingi/utgefin-efni/arsskyrslur">
                      <span
                        style={{
      ...
      <Box>
        ...
        <Box marginBottom={8}>
          ...
          <Text variant="default" marginBottom={5}>
            Handbókin er uppflettirit um starfsemi þingsins og alþingismenn.
            Lesið meira um innihald handbókar í <a>Um handbók Alþingis.</a>
          </Text>
          <MenuItem title="Handbók Alþingis 2017" href="#" />
          <MenuItem title="Handbók Alþingis 2016" href="#" />
          <MenuItem title="Handbók Alþingis 2013" href="#" />
          <MenuItem title="Handbók Alþingis 2009" href="#" />
          <MenuItem title="Handbók Alþingis 2007" href="#" />
          <MenuItem title="Handbók Alþingis 2003" href="#" />
          <MenuItem title="Handbók Alþingis 1999" href="#" />
        </Box>
      </Box>
    </Page>
  )
